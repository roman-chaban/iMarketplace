...
import styles from "../../AccessorTechSpecs/AccessorTechSpecsStyles.module.scss";
import { Tablet } from "../../../interfaces/tablets";

interface TabletTechSpecsProps {
  accessor: Tablet;
  selectMemory: string;
}

export const TabletsTechSpecs: FC<TabletTechSpecsProps> = ({
  accessor,
  selectMemory,
}) => {
  if (!accessor) {
